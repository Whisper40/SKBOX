...
if FONCYES "$VALIDE"; then
	...
	while :; do
		...
		echo ""
		echo -e "${CMAG}###### 					 ######${CEND}"
		echo -e "${CMAG}###### Fonctions de base ######${CEND}" #THANKS BONOBOX
		echo -e "${CMAG}###### 					 ######${CEND}"
		...
		echo ""
		echo -e "${CMAG}###### 					 ######${CEND}"
		echo -e "${CMAG}######      Modules      ######${CEND}" # THANKS RATXABOX
		echo -e "${CMAG}###### 					 ######${CEND}"
		...
		set "856" "870" ; FONCTXT "$1" "$2" ; echo -e "${CYELLOW}$TXT1${CEND} ${CGREEN}$TXT2${CEND}" #nextcloud 60
		set "260"; FONCTXT "$1"; echo -n -e "${CBLUE}$TXT1 ${CEND}"

		echo ""
		echo -e "${CMAG}###### 					 ######${CEND}"
		echo -e "${CMAG}######    Maintenance    #######${CEND}"
		echo -e "${CMAG}###### 					 ######${CEND}"
		set "902" "900" ; FONCTXT "$1" "$2" ; echo -e "${CYELLOW}$TXT1${CEND} ${CGREEN}$TXT2${CEND}" #plex 50
		set "906" "904" ; FONCTXT "$1" "$2" ; echo -e "${CYELLOW}$TXT1${CEND} ${CGREEN}$TXT2${CEND}" #emby 51
		set "910" "908" ; FONCTXT "$1" "$2" ; echo -e "${CYELLOW}$TXT1${CEND} ${CGREEN}$TXT2${CEND}" #openvpn 52
		set "914" "912" ; FONCTXT "$1" "$2" ; echo -e "${CYELLOW}$TXT1${CEND} ${CGREEN}$TXT2${CEND}" #filebot 53
		set "918" "916" ; FONCTXT "$1" "$2" ; echo -e "${CYELLOW}$TXT1${CEND} ${CGREEN}$TXT2${CEND}" #SyncThing 54
		set "922" "920" ; FONCTXT "$1" "$2" ; echo -e "${CYELLOW}$TXT1${CEND} ${CGREEN}$TXT2${CEND}" #sickrage 55
		set "848" "826" ; FONCTXT "$1" "$2" ; echo -e "${CYELLOW}$TXT1${CEND} ${CGREEN}$TXT2${CEND}" #couchpotato 56
		set "850" "828" ; FONCTXT "$1" "$2" ; echo -e "${CYELLOW}$TXT1${CEND} ${CGREEN}$TXT2${CEND}" #medusa 57
		set "852" "834" ; FONCTXT "$1" "$2" ; echo -e "${CYELLOW}$TXT1${CEND} ${CGREEN}$TXT2${CEND}" #esm 58
		set "854" "864" ; FONCTXT "$1" "$2" ; echo -e "${CYELLOW}$TXT1${CEND} ${CGREEN}$TXT2${CEND}" #jackett 59
			...
			205)
				...
				if [ -d "/home/$USER" ]; then
					...
					if ['$answer' == 'Y']; then
						...
						if [[ "$Nombre" == +([0-9]) ]]; then
							lvresize -L +"$Nombre"G /dev/mapper/vghome-"$USER"
							resize2fs /dev/mapper/vghome-"$USER"
